...
export default class HomeScreen1 extends React.Component {
  ...
  componentWillMount(){
    //picking up props passed by calling view before rendering this view
   console.log( this.props.navigation.getParam("location", "defaultValue"));
      ...
      <View style={styles.container}>
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.getStartedContainer}>
            ...
            <Text style={styles.getStartedText}>D R U gi ekran</Text>
